        ...
        <div  align="left" style="padding: 10px">
            <div>
                ...
                <div style="float:right; text-align: center">
                    <h5 class="font-weight-bold" >HRM</h5>
                    <h5 class="font-weight-bold" style="margin-top: -25px">#Address</h5>
                    <h6 style="margin-top: -25px">1-888-401-9555 | 587-401-3838</h6>
                    <h6 style="margin-top: -25px">info@hrm.com | hrm.pa</h6>
                </div>
            </div>


            <p>Your account has been successfully created.Admin will accept your account within 24 Hour.</p>
            <h4>Web Login</h4>
            <p>User Name <b>{{$demo->username}}</b></p>
            <p>Passowrd <b>{{$demo->password}}</b></p>
            <p><a href="{{route('payment',['id' => $demo->id,'hash' => md5($demo->id)])}}">For Buy package click the link</a> </p>
            <div align="right">
                Thank You,
                <br/>
                <i>HRM</i>
