                    ...
                    <ul class="menu-nav">
                                ...
                                <ul class="menu-subnav">
                                    ...
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="{{route('shift')}}" class="menu-link">
                                            ...
                                            <span class="menu-text">Create Shift</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
                                ...
                                <ul class="menu-subnav">
                                    ...
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="{{route('leave')}}" class="menu-link">
                                            ...
                                            <span class="menu-text">Create Leave</span>
                                        </a>
                                    </li>
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="{{route('request_leave')}}" class="menu-link">
                                            <i class="menu-bullet menu-bullet-dot">
                                                <span></span>
                                            </i>
                        ...
                        <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                            <a href="javascript:;" class="menu-link menu-toggle">
                                ...
                                <span class="menu-text">Employee Type</span>
                                <i class="menu-arrow"></i>
                            </a>
                            <div class="menu-submenu">
                                <i class="menu-arrow"></i>
                                <ul class="menu-subnav">
                                    ...
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="{{route('employee_type')}}" class="menu-link">
                                            <i class="menu-bullet menu-bullet-dot">
                                                <span></span>
                                            </i>
                                            <span class="menu-text">Careate Employee Type</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                            ...
                            <div class="menu-submenu">
                                ...
                                <ul class="menu-subnav">
                                    ...
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="{{route('supervisor_name')}}" class="menu-link">
                                            <i class="menu-bullet menu-bullet-dot">
                                                <span></span>
                                            </i>
                                            <span class="menu-text">Careate Supervisor</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                            <a href="javascript:;" class="menu-link menu-toggle">
                                ...
                                <span class="menu-text">Race</span>
                                <i class="menu-arrow"></i>
                            </a>
                            <div class="menu-submenu">
                                <i class="menu-arrow"></i>
                                <ul class="menu-subnav">
                                    ...
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="{{route('race')}}" class="menu-link">
                                            <i class="menu-bullet menu-bullet-dot">
                                                <span></span>
                                            </i>
                                            <span class="menu-text">Careate Race</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                            ...
                            <div class="menu-submenu">
                                ...
                                <ul class="menu-subnav">
                                    ...
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="{{route('religion')}}" class="menu-link">
                                            <i class="menu-bullet menu-bullet-dot">
                                                <span></span>
                                            </i>
                                            <span class="menu-text">Careate Religion</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                            <a href="javascript:;" class="menu-link menu-toggle">
                                ...
                                <span class="menu-text">Nationality</span>
                                <i class="menu-arrow"></i>
                            </a>
                            <div class="menu-submenu">
                                <i class="menu-arrow"></i>
                                <ul class="menu-subnav">
                                    ...
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="{{route('nationality')}}" class="menu-link">
                                            <i class="menu-bullet menu-bullet-dot">
                                                <span></span>
                                            </i>
                                            <span class="menu-text">Careate Nationality</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                            ...
                            <div class="menu-submenu">
                                ...
                                <ul class="menu-subnav">
                                    ...
                                    {{--<li class="menu-item" aria-haspopup="true">--}}
                                        {{--<a href="{{route('manage_employee')}}" class="menu-link">--}}
                                            {{--<i class="menu-bullet menu-bullet-dot">--}}
                                                {{--<span></span>--}}
                                            {{--</i>--}}
                        ...
                        <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                            ...
                            <div class="menu-submenu">
                                ...
                                <ul class="menu-subnav">
                                    ...
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="{{route('account_request')}}" class="menu-link">
                                            <i class="menu-bullet menu-bullet-dot">
                                                <span></span>
                                            </i>
                                ...
                                <ul class="menu-subnav">
                                    ...
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="{{route('package')}}" class="menu-link">
                                            ...
                                            <span class="menu-text">Create Package</span>
                                        </a>
                                    </li>
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="{{route('manage_package')}}" class="menu-link">
                                            <i class="menu-bullet menu-bullet-dot">
                                                <span></span>
                                            </i>
                        ...
                        <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                            ...
                            <div class="menu-submenu">
                                ...
                                <ul class="menu-subnav">
                                    ...
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="{{route('paypal/setting')}}" class="menu-link">
                                            <i class="menu-bullet menu-bullet-dot">
                                                <span></span>
                                            </i>
                                            <span class="menu-text">Paypal Settings</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                            ...
                            <div class="menu-submenu">
                                ...
                                <ul class="menu-subnav">
                                    ...
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="{{route('apply_leave')}}" class="menu-link">
                                            <i class="menu-bullet menu-bullet-dot">
                                                <span></span>
                                            </i>
                            ...
                            <div class="dropdown-menu p-0 m-0 dropdown-menu-anim-up dropdown-menu-sm dropdown-menu-right">
                                ...
                                <ul class="navi navi-hover py-4">
                                    ...
                                    <li class="navi-item">
                                        <a href="#" class="navi-link">
													<span class="symbol symbol-20 mr-3">
														<img src="{{URL::asset('assets/media/svg/flags/226-united-states.svg')}}" alt="" />
													</span>
                                    ...
                                    <li class="navi-item active">
                                        <a href="#" class="navi-link">
													<span class="symbol symbol-20 mr-3">
														<img src="{{URL::asset('assets/media/svg/flags/128-spain.svg')}}" alt="" />
													</span>
                                    ...
                                    <li class="navi-item">
                                        <a href="#" class="navi-link">
													<span class="symbol symbol-20 mr-3">
														<img src="{{URL::asset('assets/media/svg/flags/162-germany.svg')}}" alt="" />
													</span>
                                    ...
                                    <li class="navi-item">
                                        <a href="#" class="navi-link">
													<span class="symbol symbol-20 mr-3">
														<img src="{{URL::asset('assets/media/svg/flags/063-japan.svg')}}" alt="" />
													</span>
                                    ...
                                    <li class="navi-item">
                                        <a href="#" class="navi-link">
													<span class="symbol symbol-20 mr-3">
														<img src="{{URL::asset('assets/media/svg/flags/195-france.svg')}}" alt="" />
													</span>
            ...
            <div class="footer bg-white py-4 d-flex flex-lg-column" id="kt_footer">
                ...
                <div class="container-fluid d-flex flex-column flex-md-row align-items-center justify-content-between">
                    ...
                    <div class="text-dark order-2 order-md-1">
                        ...
                        <a href="http://keenthemes.com/metronic" target="_blank" class="text-dark-75 text-hover-primary">HRM</a>
                    </div>
                    <!--end::Copyright-->
                    <!--begin::Nav-->
        ...
        <div class="offcanvas-wrapper mb-5 scroll-pull">
            ...
            <div class="d-flex align-items-center justify-content-between py-8">
                ...
                <a href="#" class="symbol symbol-70 flex-shrink-0">
                    <img src="{{URL::asset('assets/media/stock-600x400/img-1.jpg')}}" title="" alt="" />
                </a>
            </div>
            <!--end::Item-->
            <!--begin::Separator-->
            ...
            <div class="d-flex align-items-center justify-content-between py-8">
                ...
                <a href="#" class="symbol symbol-70 flex-shrink-0">
                    <img src="{{URL::asset('assets/media/stock-600x400/img-2.jpg')}}" title="" alt="" />
                </a>
            </div>
            <!--end::Item-->
            <!--begin::Separator-->
            ...
            <div class="d-flex align-items-center justify-content-between py-8">
                ...
                <a href="#" class="symbol symbol-70 flex-shrink-0">
                    <img src="{{URL::asset('assets/media/stock-600x400/img-3.jpg')}}" title="" alt="" />
                </a>
            </div>
            <!--end::Item-->
            <!--begin::Separator-->
            ...
            <div class="d-flex align-items-center justify-content-between py-8">
                ...
                <a href="#" class="symbol symbol-70 flex-shrink-0">
                    <img src="{{URL::asset('assets/media/stock-600x400/img-4.jpg')}}" title="" alt="" />
                </a>
            </div>
            <!--end::Item-->
            <!--begin::Separator-->
            ...
            <div class="d-flex align-items-center justify-content-between py-8">
                ...
                <a href="#" class="symbol symbol-70 flex-shrink-0">
                    <img src="{{URL::asset('assets/media/stock-600x400/img-8.jpg')}}" title="" alt="" />
                </a>
            </div>
            <!--end::Item-->
        </div>
...
<script src="{{URL::asset('assets/js/pages/custom/wizard/wizard-4.js?v=7.0.3')}}"></script>
<script>
    @yield('script')
</script>
</body>
